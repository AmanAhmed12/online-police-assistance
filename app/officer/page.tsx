...
import { getIssuedFines } from '@/app/services/fineService';
        ...
        <Box sx={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            <Grid container spacing={3} mb={5}>
                {[
                    ...
                    { title: "Total Fines Issued", count: `Rs. ${totalFinesAmount.toLocaleString()}`, icon: <AccountBalanceWalletIcon sx={{ fontSize: 36, color: '#00bfa5' }} />, progress: 100, color: 'success' }
                ].map((stat, idx) => (
